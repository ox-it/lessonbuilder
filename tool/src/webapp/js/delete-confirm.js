...
$(function() {
		...
		$('#delete-item, #delete-multimedia-item, #delete-youtube-item, #delete-movie-item, #delete-question-item, #delete-text-item, #delete-twitter-item, #delete-announcements-item, #delete-forum-summary-item').click(function(event) {
			delbutton = $(this);
